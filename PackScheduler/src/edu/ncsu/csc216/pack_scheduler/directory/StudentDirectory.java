...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if password entered is invalid by equaling
	 *                                  null or an empty string, and if the
	 ...
	 * @throws IllegalArgumentException if it cannot get hash password
	 */
