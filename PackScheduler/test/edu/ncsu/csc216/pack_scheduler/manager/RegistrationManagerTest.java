...
public class RegistrationManagerTest {
	...
	/**
	 * Tests RegistrationManager.getLogin() method
	 */
	@Test
	public void testLogin() {
		try {
			...
			String pw = manager.getFacultyDirectory().getFacultyById("awitt").getPassword();
	...
	/**
	 * Tests RegistrationManager.getFacultyDirectory() method
	 */
	@Test
	...
	/**
	 * Tests RegistrationManager.getLogout() method
	 */
	@Test
	public void testLogout() {
		...
		manager.logout();
		assertTrue(manager.login(prop.getProperty("id"), prop.getProperty("pw")), "No match");
	}
	
	/**
	 * Test RegistrationManager.getCurrentUser();
	 */
	@Test
	...
	/**
	 * Test login method with invalid login
	 */
	@Test
	public void testLoginFailure() {
	    assertThrows(IllegalArgumentException.class, () -> manager.login("nonexistentuser", "wrongpassword"));
	    assertNull(manager.getCurrentUser());
	}

	
	/**
	 * Test RegistrationManager.getInstance()
	 */
	 @Test
	    public void testGetInstance() {
	        RegistrationManager firstInstance = RegistrationManager.getInstance();
